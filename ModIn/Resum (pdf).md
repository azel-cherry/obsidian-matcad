...
==**Mitjana** poblacional==:
> 
> $\boldsymbol{\mu} = \text{E}(X) = \begin{cases}
\,\,\displaystyle \sum_{i=1}^{n} x\,f(x) \quad&\text{si }X\text{ discreta}\\[0.5em]
\,\,\displaystyle \int_{-\infty}^{+\infty}x\,f(x)\,dx \,\,&\text{si }X\text{ contínua}
\end{cases}$
> 
...
> + $|\text{E}(X)| = \text{E}(|X|)$
> + $\displaystyle \text{E}(X^{2}) = \begin{cases}
\,\,\displaystyle \sum_{i=1}^{n} x^2\,f(x) \quad&\text{si }X\text{ discreta}\\[0.4em]
\,\,\displaystyle \int_{-\infty}^{+\infty}x^2\,f(x)\,dx \,\,&\text{si }X\text{ contínua}
\end{cases}$
> ```
...
$\quad\boldsymbol{\overline{X}} = \frac{1}{n}\sum\limits_{i=1}^{n} X_i$
...
+ $\displaystyle\sum\limits_{i=1}^n (X_i-\overline{X})^2 = \sum_{i=1}^{n}Xi^{2}-\frac{n}{n-1}\overline{X}^{2}$
````
